...
(37,1,1,'Water leakage during operation','Inspect the door seal for cracks or wear and replace if damaged.','2024-12-19 03:47:47'),
(40,1,4,'Water not draining','Check the water pump for blockages or damage and clean or replace if needed.','2024-12-19 03:47:47'),
(43,1,7,'Drum not rotating','Inspect the drive belt for damage or wear and replace if needed.','2024-12-19 03:47:47'),
(46,4,10,'Dryer not heating','Check the heating element for faults and replace if broken.','2024-12-19 03:47:47'),
(49,4,13,'Drum not spinning','Inspect the drum belt for wear or breakage and replace if necessary.','2024-12-19 03:47:47'),
(52,4,16,'Temperature too high or too low','Check the thermostat for calibration and replace if faulty.','2024-12-19 03:47:47'),
(55,7,19,'Refrigerator not cooling properly','Check the thermostat and adjust settings or replace if malfunctioning.','2024-12-19 03:47:47'),
(58,7,22,'Water dispenser not working','Replace the water filter if clogged or damaged.','2024-12-19 03:47:47'),
(61,7,25,'Refrigerator not cooling at all','Inspect the compressor for signs of failure and replace if necessary.','2024-12-19 03:47:47'),
(64,10,28,'Food not heating evenly','Check the turntable for proper movement and replace if damaged.','2024-12-19 03:47:47'),
(67,10,31,'Microwave not heating','Inspect the magnetron for failure and replace if faulty.','2024-12-19 03:47:47'),
(70,10,34,'Microwave not starting','Ensure the door switch is functioning and replace if it fails to engage.','2024-12-19 03:47:47'),
(73,13,37,'Dishes not getting clean','Check the spray arm for blockages and clean or replace if necessary.','2024-12-19 03:47:47'),
(76,13,40,'Dishwasher not draining','Inspect the drain pump for blockages and clean or replace if needed.','2024-12-19 03:47:47'),
(79,13,43,'Dishwasher making noise','Check the dish rack for misalignment and ensure the drain pump is functioning properly.','2024-12-19 03:47:47'),
(82,16,46,'Oven not heating up','Inspect the oven element for damage and replace if needed.','2024-12-19 03:47:47'),
(85,16,49,'Oven temperature inconsistent','Check the control board for malfunction and replace if necessary.','2024-12-19 03:47:47'),
(88,16,52,'Heat escaping from oven door','Inspect the oven door seal for wear or damage and replace if necessary.','2024-12-19 03:47:47');
...
-- Dump completed on 2024-12-19  3:49:10
